...
배달 완료에 대한 </div>
        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    <DeliverymatchingDriver :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" 
        ...
        <v-row>
            <DeliverymatchingDriver :offline="offline" class="video-card" v-for="(value, index) in values" v-model="values[index]" v-bind:key="index" @delete="remove"/>
        </v-row>
    </div>
</template>
...
<script>
    ...
    import DeliverymatchingDriver from './../DeliverymatchingDriver.vue';

    export default {
        name: 'DeliverymatchingDriverManager',
        components: {
            DeliverymatchingDriver,
        },
        props: {
            offline: Boolean
        },
